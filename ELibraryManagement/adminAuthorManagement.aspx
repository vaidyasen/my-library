                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="button-div col-4">
                                <asp:Button ID="Button2" class="btn text-light btn-lg btn-block btn-success" 
                                    runat="server" Text="Add" OnClick="Button2_Click" />
                            </div>
                            <div class="button-div col-4">
                                <asp:Button ID="Button3" class="btn text-light btn-lg btn-block btn-warning" 
                                    runat="server" Text="Update" OnClick="Button3_Click" />
                            </div>
                            <div class="button-div col-4">
                                <asp:Button ID="Button4" class="btn text-light btn-lg btn-block btn-danger" 
