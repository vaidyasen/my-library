        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            bool checkMemberExists()
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SELECT member_id from member_status_tbl where member_id='" + TextBox8.Text.Trim() + "'", con);
            ...
            void signUpNewMember()
            {
                ...
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("INSERT INTO member_status_tbl" +
